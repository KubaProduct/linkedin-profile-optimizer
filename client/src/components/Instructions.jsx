const steps = [
  ...
  'Kliknij przycisk oznaczony "..." na swoim profilu, a następnie wybierz "Zapisz jako PDF".',
...
export default function Instructions() {
  return (
    <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-4">
      ...
      <div className="mt-3 flex items-start gap-2 p-2.5 rounded-xl bg-amber-500/5 border border-amber-500/20 ml-9">
        <p className="text-amber-400/80 text-xs">
          <strong className="text-amber-400">Prywatność:</strong> Twój plik nie jest trwale przechowywany na naszych serwerach.
        </p>
      </div>
    </div>
  );
